...
if (!class_exists('ICalCore')) {
    class ICalCore
    {
        ...
        public function __construct()
        {
            ...
            Eventy::addFilter('property_fillable', [$this, '_addFillableFields'], 20, 1);
            ...
            // Eventy::addFilter('property_fields', [$this, '_addICalSettinFields'], 20, 1);
            ...
            Eventy::addAction('gmz_screen_edit_property', [$this, '_addScriptEditService'], 20, 1);
            ...
            Eventy::addAction('gmz_property_custom_price_meta_tab', [$this, '_addICalURLService'], 20, 1);
        ...
        public function _addICalSettinFields($settings)
        {
            // Check if 'custom_price' exists in the settings array
            if (!isset($settings['custom_price'])) {
