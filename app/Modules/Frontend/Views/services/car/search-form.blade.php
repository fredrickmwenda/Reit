            ...
            <div class="cont">
                <div class="row">
                    ...
                    @if(!empty($car_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($car_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="car_types[]" value="{{$key}}"><span style="color: black;">{{get_translate($type)}}</span></label>
                            @endforeach
                    ...
                    @if(!empty($car_features))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            <div class="search-form__label" style="color: black; text-align:left; padding-left:10px;">{{__('Features')}}</div>
                            @foreach($car_features as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="car_features[]" value="{{$key}}"><span style="color: black;">{{get_translate($value)}}</span></label>
                            @endforeach
                    ...
                    @if(!empty($car_equipments))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            <div class="search-form__label" style="color: black; text-align:left; padding-left:10px;">{{__('Equipments')}}</div>
                            @foreach($car_equipments as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="car_equipments[]" value="{{$key}}"><span style="color: black;">{{get_translate($value)}}</span></label>
                            @endforeach
