<div class="modal fade hotel-enquiry-modal" id="propertyEnquiryModal" tabindex="-1" aria-labelledby="propertyEnquiryModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="gmz-form-action enquiry-form-single" action="{{ url('property-send-enquiry') }}" method="POST">
            <div class="modal-header">
                <h5 class="modal-title" id="modelEnquiryModalLabel">{{__('ENQUIRY FORM')}}</h5>
