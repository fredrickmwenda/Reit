                ...
                <div class="row">
                    ...
                    @if(!empty($property_types))
                        <div class="col-md-6 gmz-checkbox-wrapper mb-2">
                            <div class="search-form__label" style="color: black; text-align:left; padding-left:10px;">{{__('Property Types')}}</div>
                            @foreach($property_types as $key => $type)
                                <label class="checkbox-inline">
                                    <input type="checkbox" class="gmz-checkbox-item" name="property_types[]" value="{{$key}}">
                                    <span style="color: black;">{{get_translate($type)}}</span>
                                </label>
                            @endforeach
                    ...
                    @if(!empty($hotel_facilities))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            <div class="search-form__label" style="color: black; text-align:left; padding-left:10px;">{{__('Facilities')}}</div>
                            @foreach($hotel_facilities as $key => $value)
                                <label class="checkbox-inline">
                                    <input type="checkbox" class="gmz-checkbox-item" name="hotel_facilitiess[]" value="{{$key}}">
                                    <span style="color: black;">{{get_translate($value)}}</span>
                                </label>
                            @endforeach
                    ...
                    @if(!empty($hotel_services))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            <div class="search-form__label" style="color: black; text-align:left; padding-left:10px;">{{__('Services')}}</div>
                            @foreach($hotel_services as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="hotel_servicess[]" value="{{$key}}"><span style="color: black;">{{get_translate($value)}}</span></label>
                            @endforeach
