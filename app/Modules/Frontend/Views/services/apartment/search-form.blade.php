...
<div class="booking-type d-flex align-items-center">
    ...
    <a href="javascript:void(0);" data-type="month" class="@if($bookingType == 'month') active @endif">{{__('By Month')}}</a>
    <a href="javascript:void(0);" data-type="year" class="@if($bookingType == 'year') active @endif">{{__('By Year')}}</a>
</div>
        ...
        <div class="search-form__guest apartment">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownGuestButton">
                    ...
                    <div class="item d-flex align-items-center justify-content-between">
                        <div class="label" style="color: black;">{{__('Children')}}</div>
                        <div class="value">
                    ...
                    <div class="item d-flex align-items-center justify-content-between">
                        <div class="label"style="color: black;" >{{__('Infants')}}</div>
                        <div class="value">
                    ...
                    @if(!empty($apartment_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($apartment_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="apartment_types[]" value="{{$key}}"><span style="color: black;">{{get_translate($type)}}</span></label>
                            @endforeach
                    ...
                    @if(!empty($apartment_amenity))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($apartment_amenity as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="apartment_amenities[]" value="{{$key}}"><span style="color: black;">{{get_translate($value)}}</span></label>
                            @endforeach
