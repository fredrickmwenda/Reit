...
<li>
    <span class="label">{{__('Period')}}</span>
    <span class="value">
        @if(isset($cart['cart_data']['number_month']))
            {{sprintf(_n(__('%s month'), __('%s months'), $cart['cart_data']['number_month']), $cart['cart_data']['number_month'])}}
        @else
            {{__('Number of months not available')}}
        @endif
    </span>
</li>
...
<li>
    <span class="label">{{__('Period')}}</span>
    <span class="value">
        @if(isset($cart['cart_data']['number_year']))
            {{sprintf(_n(__('%s year'), __('%s years'), $cart['cart_data']['number_year']), $cart['cart_data']['number_year'])}}
        @else
            {{__('Number of years not available')}}
        @endif
    </span>
</li>
