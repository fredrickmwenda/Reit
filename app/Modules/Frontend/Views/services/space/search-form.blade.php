                    ...
                    @if(!empty($space_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($space_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="space_types[]" value="{{$key}}"><span style="color: black;">{{get_translate($type)}}</span></label>
                            @endforeach
                    ...
                    @if(!empty($space_amenity))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($space_amenity as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="space_amenities[]" value="{{$key}}"><span style="color: black;">{{get_translate($value)}}</span></label>
                            @endforeach
