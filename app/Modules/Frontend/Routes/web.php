...
Route::group([
    ...
    // Route::get('subscriptionView', 'PageController@contactUsView')->name('contact-us');
    Route::post('contact-us', 'PageController@contactUsAction');


    Route::get('pricing', 'PageController@subscriptionView')->name('pricing');
    Route::post('pricing/{id}', 'SubscriptionPlanController@subscribe')->name('pricing-subscribe');
    // handlePaymentCallback 
    //register it in paystack
    Route::get('paystack/callback', 'SubscriptionPlanController@handlePaymentCallback');
...
Route::group([
    'namespace' => $namespace,
    'middleware' => ['web', 'locale', 'property_enable'],
], function () {
    Route::get('property', 'PropertyController@propertyPageView')->name('property');
    Route::get('property-search', 'PropertyController@propertySearchView')->name('property-search');
    Route::post('property-search', 'PropertyController@propertySearchAction');
    Route::get('property/{slug}', 'PropertyController@singleView')->name('property-single');
    Route::post('property-add-cart', 'PropertyController@addCartAction');
    Route::post('property-fetch-calendar-availability', 'PropertyController@fetchAvailabilityAction');
    // Route::post('property-fetch-time', 'PropertyController@fetchTimeAction');
    Route::post('property-get-real-price', 'PropertyController@getRealPriceAction');
    Route::post('property-send-enquiry', 'PropertyController@sendEnquiryAction');
});
//Hotel
Route::group([
    'namespace' => $namespace,
