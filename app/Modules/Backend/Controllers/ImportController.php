    ...
    public function importDataAction(Request $request)
    {
        ...
        if (!empty($check_text) && !is_null($check_text)) {
            if ($check_text == 'Import') {
                $this->resetData();
                $this->resetData();
                $file_names = ['post', 'page', 'hotel', 'room', 'room_availability', 'apartment', 'apartment_availability','property', 'property_availability', 'space', 'space_availability', 'tour', 'tour_availability', 'car', 'car_availability', 'menu', 'menu_structure', 'comment', 'coupon', 'earnings', 'language', 'media', 'notification', 'options', 'order', 'term', 'term_relation', 'withdrawal', 'agent', 'agent_availability', 'agent_relation', 'beauty', 'beauty_availability'];
