...
return [
    ...
    'post_types' => [
        ...
        'property' => [
            'singular' => ilangs('Property'),
            'plural' => ilangs('Properties'),
            'slug' => 'property'
        ],
    ...
    'admin_menu' => [
        ...
        'analytics' => [
            'type' => 'item',
            'label' => ilangs('Google Analytics'),
            'icon' => 'fa-analytics',
            'screen' => 'get-analytics',
        ],
        'earning_report' => [
            'type' => 'parent',
        ...
        'heading_service' => [
            'type' => 'heading',
            'services' => ['car', 'property','apartment', 'hotel', 'space', 'tour'],
        ...
        'property' => [
            'type' => 'parent',
            'label' => ilangs('Selling Properties'),
            ...
            'child' => [
                ...
                [
                    'type' => 'item',
                    'label' => ilangs('Types'),
                    'screen' => 'term/sale-type',
                ],
                [
                    'type' => 'item',
                    'label' => ilangs('Amenities'),
                    'screen' => 'term/property-amenity',
                ],
                [
                    'type' => 'item',
                    'label' => ilangs('Reviews'),
                ...
                [
                    'type' => 'item',
                    'label' => ilangs('Orders'),
                    'screen' => 'order/property',
                ],
            ],
            'screen' => ['all-properties', 'new-property', 'edit-property', 'term/sale-type', 'term/property-amenity', 'property-review', 'order/property', 'new-term/sale-type', 'edit-term/sale-type', 'new-term/property-amenity', 'edit-term/property-amenity']
        ],
        ...
        'subscription' => [
            ...
            'screen' => ['subscription', 'feature', 'subscriptions'],
        ],
        'settings' => [
            'type' => 'item',
    ...
    'partner_menu' => [
        ...
        'heading_service' => [
            'type' => 'heading',
            'services' => ['car', 'apartment','property', 'hotel', 'space', 'tour'],
            'label' => ilangs('All Services')
        ],
        'hotel' => [
            'type' => 'parent',
        ...
        'property' => [
            ...
            'screen' => ['all-properties', 'new-property', 'edit-property', 'property-review', 'order/property']
        ],
        ...
        'subscription' => [
            ...
            'screen' => ['partner-subscriptions', 'subscription-plans'],
        ],
        'media' => [
            'type' => 'item',
            'label' => ilangs('Media'),
