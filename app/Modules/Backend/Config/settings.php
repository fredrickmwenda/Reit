                    ...
                    [
                        ...
                        'fields' => [
                            ...
                            [
                                ...
                                'break' => true,
                                'tab' => 'property_service',
                                'condition' => 'property_enable:on'
                            ],
                            [
                                'id' => 'property_show_partner_info',
                                'label' => ilangs('Display owner info in detail page'),
                                'type' => 'switcher',
                                'layout' => 'col-12 col-md-8',
                                'std' => 'on',
                            ...
                            [
                                'id' => 'property_list_location',
                                'type' => 'list_item',
                                'label' => ilangs('List Locations'),
                                'translation' => true,
                                'binding' => 'name',
                                'fields' => [
                                    [
