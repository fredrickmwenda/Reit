...
if (!function_exists('placeholder_image')) {
	function placeholder_image($size = 'full')
	{
		switch ($size) {
			case 'full':
				$url = '/images/tour_default_1200x900.jpg';
				break;
			case 'medium':
				$url = '/images/tour/tour_default_800x600.jpg';
				break;
			case 'small':
				$url = '/images/tour/tour_default_400x300.jpg';
				break;
			case [360, 240]:
				$url = '/images/tour_default_360X240.jpg';
				break;
			case [50, 50]:
				$url = '/images/tour/tour_default_50x50.jpg';
				break;
			case [100, 100]:
				$url = '/images/tour/author.png';
				break;
			case [120, 120]:
				$url = '/images/tour/author.png';
				break;
