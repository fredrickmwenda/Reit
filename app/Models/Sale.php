...
class Sale extends Model
{
    ...
    public function setFillable()
    {
        ...
        $this->fillable = Eventy::filter(
            'property_fillable', [
            'post_title', 'post_slug', 'post_content', 'post_description', 
            'location_lat', 'location_lng', 'location_address', 'location_zoom',
             'thumbnail_id', 'gallery', 'base_price', 
            //  'booking_form', 'number_of_guest', 'number_of_bedroom', 'number_of_bathroom', 
             'size', 
            //  'min_stay', 'max_stay', 
             'extra_services', 
             'property_type', 
             'property_amenity', 
            //  'enable_cancellation', 'cancel_before', 
            //  'cancellation_detail', 
