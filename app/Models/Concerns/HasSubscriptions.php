...
use App\Events\FeatureTicketCreated;
...
trait HasSubscriptions
{
    ...
    {
        return $this->hasManyThrough(SubscriptionRenewal::class,
            Subscription::class,
            'subscriber_id',
        );
    }
    ...
    public function numberOfSubscribersInPlan(Plan $plan): int
    {
        return $this->whereHas('subscription', function ($query) use ($plan) {
    ...
    public function getSubscriptionLevelAttribute()
    {
        ...
        // Check if the subscription is null before accessing its plan property
        if ($subscription && $subscription->plan) {
            return $subscription->plan->name;
        }
    
        // Handle the case where either $subscription or $subscription->plan is null
        return 'defaultSubscription'; // Or you can return any default value or handle it according to your logic
    }
}
