...
class OrderService extends AbstractService
{
    ...
    public function checkOut(Request $request)
    {
        ...
        if (!empty($cart)) {
            ...
            if ($serviceObject) {
                ...
                } else if ($post_type == GMZ_SERVICE_HOTEL) {
                ...
                } else if ($post_type ==  GMZ_SERVICE_PROPERTY) {
                ...
                if ($post_type ==  GMZ_SERVICE_PROPERTY) {
                ...
                if ($payment == 'paystack') {
                    ...
                    if (isset($after_payment['status']) && $after_payment['status']) {
                        ...
                        } elseif ($post_type == GMZ_SERVICE_PROPERTY) {
                            $rentAvaiRepo = PropertyAvailabilityRepository::inst();
                            $rentAvaiRepo->updateRentedData($serviceObject);
    ...
    public function checkPaymentCancellation($order)
    {
        ...
        if ($post_type == GMZ_SERVICE_CAR) {
            ...
            $rentRepo = PropertyRepository::inst();
            $p = $rentRepo->find($post_id);
        } elseif ($post_type == GMZ_SERVICE_TOUR) {
