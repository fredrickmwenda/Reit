(function ($) {
    ...
    var GmzSearchRent = {
        ...
        init: function (el) {
            ...
            this.renderEl = $('.list-rent__content', this.container);
        ...
        _initSearch: function(){
            ...
            base.xhrRequest = $.post(base.container.data('action'), base.dataFilter, function (respon) {
                ...
                if($('.list-half-map__left .list-rent__content').length) {
                    $('.list-rent__content', parentImage).find('img').one("load", function () {
                        $(this).addClass('loaded');
                        if ($('.list-rent__content', parentImage).find('img.loaded').length === $('.list-rent__content', parentImage).find('img').length) {
                            setTimeout(function () {
    ...
    $(document).ready(function() {
        GmzSearchRent.init('.gmz-search-result');
    });
})(jQuery);